...
const { readJsonFile, sendFailedMessage, readJsonFileAndReturnResult } = require("./reusableMethods");
...
exports.getSensors =  async  (request, response) => {
  try {
    ...
    if (fs.existsSync(mainFile)) {
      /*  -------------- Create Pagination -------------- */
      // http://localhost:5000/sensors?page=1&limit=2
